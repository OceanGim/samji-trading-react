    ...
    <div className="min-h-screen bg-gray-50">
      ...
      <section className="bg-gradient-to-r from-primary to-primary-dark py-20">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <h1 className="text-4xl md:text-5xl font-bold text-white text-center mb-4 korean-content">
            문의하기
          </h1>
          <p className="text-xl text-white/90 text-center max-w-3xl mx-auto">
            궁금하신 사항이나 견적 문의는 언제든지 연락주시면 친절히 상담해드리겠습니다
          </p>
        </div>
      </section>
          ...
          <div className="max-w-3xl mx-auto">
            <div className="bg-white rounded-xl shadow-lg p-8 sm:p-12">
              ...
              <div className="border-t pt-8">
                <div className="bg-gradient-to-r from-primary to-primary-dark p-8 rounded-xl text-center">
                  ...
                  <a
                    ...
                    className="inline-flex items-center gap-3 px-8 py-4 bg-white text-primary hover:bg-gray-50 font-bold rounded-lg transition-all duration-200 transform hover:scale-105 shadow-lg"
                  >
